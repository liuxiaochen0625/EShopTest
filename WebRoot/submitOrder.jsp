	...
	<table width="780" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<TD height="50" align="right" valign="bottom"><IMG
				...
				id="category" name="category">
					...
					src="images/icon_search.gif" align="absMiddle" border="0"> </A>
			</TD>
			<td width="20">&nbsp;</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><table width="100%" border="0" cellpadding="0"
					...
					<tr>
						<td><TABLE cellSpacing=0 cellPadding=0 border=0>
								<tr valign="center">
									...
									<td class="C_Carbg_Default"><bean:message key="cart.step1" />
									</td>
									<td><img height="39" src="images/Car_15.gif" width="1" />
									</td>
									<td align="middle"><img hspace="5" src="images/Car_09.gif" />
									</td>
									<td class="C_Carbg_Default"><bean:message key="cart.step2" />
									</td>
									<td><img height="39" src="images/Car_15.gif" width="1" />
									</td>
									<td align="middle"><img hspace="5" src="images/Car_11.gif" />
									</td>
									<td class="C_Carbg_Current"><bean:message key="cart.step3" />
									</td>
									<td><img height="39" src="images/Car_15.gif" width="1" />
									</td>
								</tr>
					...
					<tr>
						<td><table width="100%" border="0" cellpadding="0"
								...
								<tr bgcolor="#F7F3F7" class="text">
									<td width="240" rowspan="4" align="center" bgcolor="#FFFFFF"><IMG
										hspace=5 src="images/Car_icon_10.gif"></td>
								...
								<tr bgcolor="#F7F3F7" class="text">
									<fmt:formatDate value="${order.orderDate}" var="orderDateTime"
					...
					<tr align="center">
						<td><a href="order.do?method=viewOrders&id=${order.id}"><img
								src="images/orderpay.jpg" width="137" height="40" border="0"
								style="CURSOR: hand" /> </a>
						</td>
					</tr>
				</table></td>
