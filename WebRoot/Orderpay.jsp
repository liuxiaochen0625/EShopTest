...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px; border-style:solid; border-color:#888888">
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="60"><img src="images/order_pay.png" width="150" height="29" /></td>
      </tr>
      
      <tr>
        <td align="center">
        <form action="orderpay.do?method=addOrderpay&id=${order.id}" style="margin:0px;" method="post" >
			...
			<logic:present name="order" scope="request">		  
              ...
              <tr bgcolor="#F7F3F7">
        <td width="260" height="26" class="text" align="right"><bean:message key="account.pwd"/>
          ：</td>
        <td height="26"><input type="password" name="accountPwd" size="30" class="textBox" /></td>
      </tr>
       <td height="40" colspan="2" align="center">
			<input class="C_Input" type="submit" value="<bean:message key='order.pay.text'/>"/>
			</td> 
		  </logic:present>						
            </table>
             <logic:messagesPresent>
				<script language="javascript">
				   alert('<html:errors property="addOrderpayStatus"/>');
				</script>
			 </logic:messagesPresent>
	</form>            
		  </td>
